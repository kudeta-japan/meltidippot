...
/* ===== asset path helper (GH Pages でもOK) ===== */
const prefix = process.env.NEXT_PUBLIC_BASE_PATH ?? ''; // 例: "/meltdippot"
...
type Item = {
  ...
  name: string;
  description: string;
  emoji: string;      // 表示テキスト用フォールバック
  icon: string;       // 画像ファイル名（例: "veg.png"）
  accent: string;
  face: FaceExpression;
};
